...
public class Style {
    ...
    public boolean isValid() {
        return this.m_ring >= 0 && this.m_ring <= 1?(this.m_vibrate >= 0 && this.m_vibrate <= 1?(this.m_clearable >= 0 && this.m_clearable <= 1?(this.m_lights >= 0 && this.m_lights <= 1?(this.m_iconType >= 0 && this.m_iconType <= 1?this.m_styleId >= 0 && this.m_styleId <= 1:false):false):false):false):false;
    }
}
